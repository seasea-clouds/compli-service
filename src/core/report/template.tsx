        ...
        <div className="space-y-2">
          <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
            ...
            <div className="space-y-1">
              {["Confirm product HS code with customs broker", "Engage Chinese compliance agent", "Prepare company registration documents", "Collect product specifications and ingredients list"].map((item: any, i: number) => (
          ...
          <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
            ...
            <div className="space-y-1">
              {["Submit GACC/CCC/NMPA application", "Track application status weekly", "Prepare Chinese label artwork", "Arrange first shipment logistics", "Verify customs clearance documentation"].map((item: any, i: number) => (
                <label key={i} className="flex items-start gap-2 cursor-pointer group">
                  <input type="checkbox" className="mt-0.5 rounded border-gray-300 text-gold focus:ring-gold" />
                  <span className="text-xs text-gray-700 group-hover:text-primary-navy">{item}</span>
                </label>
