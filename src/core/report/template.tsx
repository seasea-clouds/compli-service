...
import type { Regulation, TimelinePhase, CostBreakdown, HorizonItem } from "../../../modules/gacc/rules";
...
function getPhase1Items(module: string): string[] {
...
function getGlossary(module: string): { term: string; def: string }[] {
    ...
    <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden print:shadow-none print:border-none">
      ...
      <div className="bg-primary-navy text-white px-8 pt-8 pb-6 print:bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-3 flex flex-wrap gap-1.5">
            {result.riskDimensions.map((d: Record<string, any>, i: number) => (
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <ul className="space-y-1">
              {result.marketIntel.keyDrivers.map((d: string, i: number) => (
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <ul className="space-y-1">
              {result.marketIntel.barriers.map((b: any, i: number) => (
                <li key={i} className="text-xs text-gray-700 flex items-start gap-1">
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="space-y-2">
          {result.regulations.filter((r: any) => r.relevance === 'primary').map((reg: any, i: number) => (
        ...
        <details className="mt-3">
          <summary className="text-xs text-gray-500 cursor-pointer hover:text-primary-navy font-semibold">
            + View secondary regulations ({result.regulations.filter((r: any) => r.relevance !== 'primary').length})
          </summary>
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-2 mb-4">
          {result.riskMatrix.map((item: any, i: number) => (
        ...
        <details>
          ...
          <div className="mt-2 space-y-1.5">
            {result.riskMatrix.filter((r: any) => r.rating !== '🟢').map((item: any, i: number) => (
            ...
            {result.riskMatrix.filter((r: any) => r.rating === '🟢').length === result.riskMatrix.length && (
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            ...
            <tbody>
              {result.documentGuide.map((doc: any, i: number) => (
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="overflow-x-auto mb-4">
          <table className="w-full text-xs border-collapse">
            ...
            <tbody>
              {result.labelGuide.requiredItems.map((item: any, i: number) => (
                <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
        ...
        <details>
          ...
          <div className="mt-2 space-y-1">
            {result.labelGuide.gb7718Highlights.map((h: any, i: number) => (
        ...
        <details className="mt-2">
          ...
          <div className="mt-2 space-y-1">
            {result.labelGuide.gb28050Highlights.map((h: any, i: number) => (
              <p key={i} className="text-[11px] text-gray-600 flex items-start gap-1">
                <span className="text-gold mt-0.5">•</span> {h}
              </p>
            ))}
            ...
            <div key={i} className="flex items-start gap-3">
              ...
              <div className="flex-1 bg-white rounded-lg p-3 border border-gray-100">
                ...
                <div className="flex gap-2 mt-1.5">
                  ...
                  {phase.dependencies.map((dep: any, j: number) => (
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <div className="px-8 py-6 border-b border-gray-100">
        <SectionTitle icon={<Icon svg={I.globe} w={5} h={5} />} label={`COUNTRY-SPECIFIC ANALYSIS: ${productInfo.originCountry || 'N/A'}`} />
        ...
        {result.countryProfile.specialRestrictions.length > 0 && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-3">
            ...
            <ul className="space-y-0.5">
              {result.countryProfile.specialRestrictions.map((r: any, i: number) => (
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <ul className="space-y-0.5">
              {result.marketIntel.topOrigins.map((o: any, i: number) => (
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="space-y-3">
          {result.commonRejections.map((item: any, i: number) => (
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            ...
            <tbody>
              {result.postApprovalObligations.map((ob: any, i: number) => (
                <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="space-y-2">
          {result.horizonScan.map((item: any, i: number) => (
        ...
        <div className="space-y-2">
          <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
            ...
            <div className="space-y-1">
              {[getPhase1Items(props.module)[0], getPhase1Items(props.module)[1], getPhase1Items(props.module)[2], getPhase1Items(props.module)[3]].map((item: any, i: number) => (
          ...
          <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
            ...
            <div className="space-y-1">
              {["Submit " + props.module + " application", "Track application status weekly", "Prepare Chinese label artwork", "Arrange first shipment logistics", "Verify customs clearance documentation"].map((item: any, i: number) => (
                <label key={i} className="flex items-start gap-2 cursor-pointer group">
                  <input type="checkbox" className="mt-0.5 rounded border-gray-300 text-gold focus:ring-gold" />
                  <span className="text-xs text-gray-700 group-hover:text-primary-navy">{item}</span>
                </label>
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
          {getGlossary(props.module).map((item: any, i: number) => (
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        ...
        <div className="space-y-3">
          {props.nextSteps.map((step: any, i: number) => (
