    ...
    <div className="min-h-screen bg-bg-ice py-8">
      <div className="max-w-4xl mx-auto px-4 mb-4">
        <div className="bg-amber-50 border border-amber-300 rounded-lg p-4 text-center mb-6">
          <p className="text-sm font-bold text-amber-800">🔬 Preview Mode — Sample: Vitamin C Brightening Serum (USA)</p>
      ...
      <ReportTemplate
        ...
        locale="en"
        labels={labels}
        productInfo={{ name: "Vitamin C Brightening Serum", category: "Skincare (HS 33.04)", hsCode: "3304.99", originCountry: "USA" }}
