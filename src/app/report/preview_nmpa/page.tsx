...
const SAMPLE_RESULT: GaccResult = {
  ...
  riskDimensions: [
    ...
    { dimension: "Origin Country Complexity", score: 5, color: "🟡", note: "France: moderate compliance pathway" },
  ...
  executiveSummary: "This comprehensive assessment evaluates Vitamin C Brightening Serum (Skincare (HS 33.04)) against all applicable Chinese import regulations. Overall risk score: 3.8/10. 🟢 Product is standard risk. Standard GACC registration pathway applies.",
  ...
  marketIntel: {
    ...
    topOrigins: [{ country: "Belgium", share: "28%" }, { country: "Switzerland", share: "22%" }, { country: "France", share: "15%" }, { country: "Italy", share: "12%" }],
    consumerPerception: "Chinese consumers generally view imported Skincare / Chocolate products favorably, associating them with higher quality and safety standards. Premium positioning is achievable.",
    keyDrivers: ["Rising middle class demand for premium imports", "Growing cosmetics safety awareness", "Cross-border e-commerce enabling direct access", "Young consumers' preference for international brands"],
  ...
  regulations: [
    ...
    { name: "Food Safety Law of China", number: "PRC Food Safety Law (2015, amended 2021)", effectiveDate: "October 1, 2015", issuingAuthority: "NPC", relevance: 'primary', description: "Primary legislation governing cosmetics safety in China." },
  ...
  riskMatrix: [
    ...
    { dimension: "产地风险 Origin Country", rating: "🟡", explanation: "France — moderate compliance pathway" },
  ...
  requiredDocuments: [
    "NMPA Cosmetics Filing Application Form",
  ...
  documentGuide: [
    { name: "NMPA Cosmetics Filing Application Form", format: "CIFER system online submission", notarization: "Not required", validity: "Per application", commonError: "Incomplete fields, missing signatory information" },
  ...
  labelGuide: {
    requiredItems: [
      ...
      { field: "Ingredient disclosure", requirement: "Mandatory: milk, eggs, fish, crustacea, peanuts, soybeans, wheat, tree nuts.", commonMistake: "Not declaring regulated allergens" },
  ...
  timelinePhases: [
    ...
    { phase: "Label Design & Compliance", duration: "2-3 weeks", description: "Design Chinese label per GB 7918/GB/T 35914. Submit for compliance review.", responsible: 'SinoTrade', dependencies: ["Product details finalized"] },
    { phase: "First Shipment & Customs Clearance", duration: "1-3 weeks", description: "First commercial shipment. CIQ inspection: document check, label verification, random sampling.", responsible: 'Both', dependencies: ["NMPA Cosmetics Filing certificate", "Label approved"] },
  ],
  costBreakdown: [
    { item: "NMPA Cosmetics Filing Fee", estimatedRange: "$200-800", notes: "CIFER system filing with professional agent handling." },
    ...
    { item: "Chinese Label Design & Compliance Review", estimatedRange: "$300-1,500", notes: "Includes GB 7718 check, safety assessment, 2 revision rounds." },
  ...
  detailedTimeline: "Standard GACC registration for Skincare / Chocolate typically takes 6-10 weeks. This assumes complete documentation and no requests for supplementary materials.",
  countryProfile: {
    importVolumeRank: 3,
  ...
  competitiveAnalysis: "China imported significant volumes of Skincare / Chocolate products in 2024-2025. Top origins include Belgium, Switzerland, France, Italy. The category shows growth potential with rising consumer demand for premium imports.",
  commonRejections: [
  ...
  postApprovalObligations: [
    ...
    { item: "Label Compliance Updates", frequency: "Per regulatory change", description: "Monitor GB 7918/GB/T 35914 updates." },
  ...
  summary: "Your product (Skincare (HS 33.04)) requires GACC registration but is classified as low risk.",
};
...
const labels = {
  ...
  labelHsCode: "HS Code",
  labelOrigin: "Origin",
  gaccRequired: "NMPA Cosmetics Filing Required",
  gaccNotRequired: "No NMPA Cosmetics Filing Required",
};
    ...
    <div className="min-h-screen bg-bg-ice py-8">
      <div className="max-w-4xl mx-auto px-4 mb-4">
        <div className="bg-amber-50 border border-amber-300 rounded-lg p-4 text-center mb-6">
          <p className="text-sm font-bold text-amber-800">🔬 Preview Mode — Sample: Vitamin C Brightening Serum (France)</p>
