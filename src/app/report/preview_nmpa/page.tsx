...
const SAMPLE_RESULT: GaccResult = {
  ...
  documentGuide: [
    { name: "NMPA Cosmetics Filing Application Form", format: "NMPA online system online submission", notarization: "Not required", validity: "Per application", commonError: "Incomplete fields, missing signatory information" },
  ...
  timelinePhases: [
    ...
    { phase: "Application Submission (CIFER)", duration: "1-2 weeks", description: "Submit registration via NMPA online system with our team handling all documentation and submission requirements.", responsible: 'SinoTrade', dependencies: ["All documents ready", "Lab reports received"] },
  ...
  costBreakdown: [
    { item: "NMPA Cosmetics Filing Fee", estimatedRange: "$200-800", notes: "NMPA online system filing with professional agent handling." },
  ...
  competitiveAnalysis: "China imported significant volumes of Confectionery / Chocolate products in 2024-2025. Top origins include Belgium, Switzerland, France, Italy. The category shows growth potential with rising consumer demand for premium imports.",
  commonRejections: [
