...
const SAMPLE_RESULT: GaccResult = {
  ...
  marketIntel: {
    ...
    consumerPerception: "Chinese consumers generally view imported Food & Beverages / Chocolate products favorably, associating them with higher quality and safety standards. Premium positioning is achievable.",
  ...
  documentGuide: [
    { name: "CBEC Compliance Application Form", format: "CIFER system online submission", notarization: "Not required", validity: "Per application", commonError: "Incomplete fields, missing signatory information" },
  ...
  costBreakdown: [
    { item: "CBEC Compliance Fee", estimatedRange: "$200-800", notes: "CIFER system filing with professional agent handling." },
  ...
  detailedTimeline: "Standard GACC registration for Food & Beverages / Chocolate typically takes 6-10 weeks. This assumes complete documentation and no requests for supplementary materials.",
  countryProfile: {
    importVolumeRank: 3,
  ...
  competitiveAnalysis: "China imported significant volumes of Food & Beverages / Chocolate products in 2024-2025. Top origins include Belgium, Switzerland, Japan, Italy. The category shows growth potential with rising consumer demand for premium imports.",
  commonRejections: [
