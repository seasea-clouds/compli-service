...
const SAMPLE_RESULT: GaccResult = {
  ...
  riskDimensions: [
    ...
    { dimension: "Origin Country Complexity", score: 5, color: "🟡", note: "Japan: moderate compliance pathway" },
  ...
  marketIntel: {
    ...
    topOrigins: [{ country: "Belgium", share: "28%" }, { country: "Switzerland", share: "22%" }, { country: "Japan", share: "15%" }, { country: "Italy", share: "12%" }],
  ...
  regulations: [
    ...
    { name: "CBEC Policy MOFCOM 2018", number: "Decree 249 (2021)", effectiveDate: "January 1, 2022", issuingAuthority: "General Administration of Customs (GACC)", relevance: 'primary', description: "Administrative Measures on Import and Export Food Safety." },
  ...
  riskMatrix: [
    ...
    { dimension: "产地风险 Origin Country", rating: "🟡", explanation: "Japan — moderate compliance pathway" },
  ...
  requiredDocuments: [
    "CBEC Compliance Application Form",
  ...
  documentGuide: [
    { name: "CBEC Compliance Application Form", format: "CBEC platform system online submission", notarization: "Not required", validity: "Per application", commonError: "Incomplete fields, missing signatory information" },
  ...
  timelinePhases: [
    ...
    { phase: "Application Submission (CIFER)", duration: "1-2 weeks", description: "Submit registration via CBEC platform system with our team handling all documentation and submission requirements.", responsible: 'SinoTrade', dependencies: ["All documents ready", "Lab reports received"] },
    ...
    { phase: "First Shipment & Customs Clearance", duration: "1-3 weeks", description: "First commercial shipment. CIQ inspection: document check, label verification, random sampling.", responsible: 'Both', dependencies: ["CBEC Compliance certificate", "Label approved"] },
  ],
  costBreakdown: [
    { item: "CBEC Compliance Fee", estimatedRange: "$200-800", notes: "CBEC platform system filing with professional agent handling." },
  ...
  competitiveAnalysis: "China imported significant volumes of Confectionery / Chocolate products in 2024-2025. Top origins include Belgium, Switzerland, Japan, Italy. The category shows growth potential with rising consumer demand for premium imports.",
  commonRejections: [
...
const labels = {
  ...
  labelHsCode: "HS Code",
  labelOrigin: "Origin",
  gaccRequired: "CBEC Compliance Required",
  gaccNotRequired: "No CBEC Compliance Required",
};
    ...
    <div className="min-h-screen bg-bg-ice py-8">
      <div className="max-w-4xl mx-auto px-4 mb-4">
        <div className="bg-amber-50 border border-amber-300 rounded-lg p-4 text-center mb-6">
          <p className="text-sm font-bold text-amber-800">🔬 Preview Mode — Sample: Organic Green Tea Matcha (Japan)</p>
      ...
      <ReportTemplate
        ...
        locale="en"
        labels={labels}
        productInfo={{ name: "Organic Green Tea Matcha", category: "Food & Beverages", hsCode: "0902.10", originCountry: "Japan" }}
