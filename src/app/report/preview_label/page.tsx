...
const SAMPLE_RESULT: GaccResult = {
  ...
  executiveSummary: "This comprehensive assessment evaluates Organic Honey Almond Granola (Prepackaged Foods (GB 7718)) against all applicable Chinese import regulations. Overall risk score: 3.8/10. 🟢 Product is standard risk. Standard GACC registration pathway applies.",
  ...
  summary: "Your product (Prepackaged Foods (GB 7718)) requires GACC registration but is classified as low risk.",
};
