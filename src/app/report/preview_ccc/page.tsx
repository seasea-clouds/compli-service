...
const SAMPLE_RESULT: GaccResult = {
  ...
  riskDimensions: [
    ...
    { dimension: "Origin Country Complexity", score: 5, color: "🟡", note: "USA: standard compliance pathway" },
  ...
  marketIntel: {
    ...
    consumerPerception: "Chinese consumers generally view imported Consumer Electronics / Chocolate products favorably, associating them with higher quality and safety standards. Premium positioning is achievable.",
  ...
  labelGuide: {
    requiredItems: [
      ...
      { field: "EMC testing", requirement: "Mandatory: milk, eggs, fish, crustacea, peanuts, soybeans, wheat, tree nuts.", commonMistake: "Not declaring regulated allergens" },
  ...
  timelinePhases: [
    ...
    { phase: "Label Design & Compliance", duration: "2-3 weeks", description: "Design Chinese label per GB 4943.1/GB 9254. Submit for compliance review.", responsible: 'SinoTrade', dependencies: ["Product details finalized"] },
  ...
  costBreakdown: [
    ...
    { item: "Chinese Label Design & Compliance Review", estimatedRange: "$300-1,500", notes: "Includes GB 7718 check, safety testing, 2 revision rounds." },
  ...
  detailedTimeline: "Standard GACC registration for Consumer Electronics / Chocolate typically takes 6-10 weeks. This assumes complete documentation and no requests for supplementary materials.",
  countryProfile: {
    importVolumeRank: 3,
  ...
  competitiveAnalysis: "China imported significant volumes of Consumer Electronics / Chocolate products in 2024-2025. Top origins include Belgium, Switzerland, USA, Italy. The category shows growth potential with rising consumer demand for premium imports.",
  commonRejections: [
  ...
  postApprovalObligations: [
    ...
    { item: "Label Compliance Updates", frequency: "Per regulatory change", description: "Monitor GB 4943.1/GB 9254 updates." },
    ...
    <div className="min-h-screen bg-bg-ice py-8">
      <div className="max-w-4xl mx-auto px-4 mb-4">
        <div className="bg-amber-50 border border-amber-300 rounded-lg p-4 text-center mb-6">
          <p className="text-sm font-bold text-amber-800">🔬 Preview Mode — Sample: Wireless Bluetooth Speaker (USA)</p>
