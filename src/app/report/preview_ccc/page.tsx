...
const SAMPLE_RESULT = {
  ...
  postApprovalObligations: [
    { item: 'Annual Factory Inspection', frequency: 'Yearly', desc: 'CNCA inspector verifies production consistency.' },
    { item: 'Product Change Notice', frequency: 'When applicable', desc: 'Design/component changes require re-evaluation.' },
    { item: 'CCC Certificate Renewal', frequency: 'Every 5 years', desc: 'Full re-evaluation. Begin 6 months before expiry.' },
    { item: 'Market Surveillance', frequency: 'Ongoing', desc: 'SAMR random product testing. Respond within 30 days.' },
  ],
  horizonScan: [
