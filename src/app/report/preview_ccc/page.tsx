...
const SAMPLE_RESULT = {
  ...
  channels: [
    { channel: 'Standard Import (一般贸易)', suitability: 'high', gaccRequired: true, description: 'Full CCC compliance channel for retail and wholesale.', advantages: ['Full market access (online + offline)', 'Build brand presence in China', 'Higher margins at scale'], disadvantages: ['CCC certification required (4-6 months)', 'Factory audit required', 'Annual surveillance inspections'], timeline: '4-6 months', costRange: '$5,000-15,000' },
    { channel: 'Cross-Border E-commerce (CBEC)', suitability: 'medium', gaccRequired: true, description: 'Sell via Tmall Global / JD Worldwide without CCC.', advantages: ['Faster market entry (1-2 months)', 'No CCC required online', 'Test market before full commitment'], disadvantages: ['Online channels only', 'Per-order limits (RMB 5,000)', 'Cannot sell in physical retail'], timeline: '1-2 months', costRange: '$500-2,000' },
  ],
  tariffInfo: { mfnRate: '5-15% (MFN)', vatRate: '13%', consumptionTax: 'N/A', ftaRate: null, totalTaxBurden: '5-15% + 13% VAT' },
  regulations: [
    { name: 'CNCA-CCC Implementation Rules', number: 'CNCA 00C-001:2023', effectiveDate: '2023', issuingAuthority: 'CNCA/SAMR', relevance: 'primary', description: 'CCC certification procedures: application, testing, factory inspection, and maintenance.' },
    { name: 'CCC Product Catalogue', number: 'CNCA 2023 Announcement', effectiveDate: '2023', issuingAuthority: 'CNCA', relevance: 'primary', description: 'Products subject to mandatory CCC certification. 17 categories including electronics.' },
    { name: 'GB 4943.1-2022', number: 'GB 4943.1-2022', effectiveDate: '2022', issuingAuthority: 'SAMR', relevance: 'primary', description: 'Safety of audio/video and IT equipment. Primary safety standard for CCC testing.' },
    { name: 'GB 9254-2021', number: 'GB 9254-2021', effectiveDate: '2021', issuingAuthority: 'SAMR', relevance: 'primary', description: 'EMC emission limits for multimedia equipment.' },
    { name: 'GB 17625.1-2022', number: 'GB 17625.1-2022', effectiveDate: '2022', issuingAuthority: 'SAMR', relevance: 'secondary', description: 'EMC harmonic current emissions limits.' },
    { name: 'China Energy Label', number: 'NDRC/MOFCOM 2020', effectiveDate: '2020', issuingAuthority: 'NDRC', relevance: 'secondary', description: 'Mandatory energy efficiency labeling for specified electronic products.' },
    { name: 'China RoHS 2', number: 'MIIT Order 32:2016', effectiveDate: '2016', issuingAuthority: 'MIIT', relevance: 'secondary', description: 'Hazardous substance limits in electronic products.' },
  ],
  ...
  costBreakdown: [
    { item: 'Type Testing (Safety + EMC)', estimatedRange: '$3,000-8,000', notes: 'CNCA-accredited lab. CB report may reduce scope.' },
    { item: 'Factory Inspection (Initial)', estimatedRange: '$2,000-5,000', notes: 'Auditor visit. Travel cost extra if outside China.' },
    { item: 'CCC Certification Fee', estimatedRange: '$1,000-3,000', notes: 'CNCA/CCIC certification body fee.' },
    { item: 'CB Report Conversion', estimatedRange: '$1,000-3,000', notes: 'If existing IEC CB test report is available.' },
    { item: 'Chinese Manual Translation', estimatedRange: '$500-2,000', notes: 'CCC requires complete Chinese user manual.' },
    { item: 'Professional Service Fee', estimatedRange: '$4,000-12,000', notes: 'End-to-end: lab coordination, factory inspection, document handling.' },
    { item: 'Annual Factory Follow-up', estimatedRange: '$1,500-3,000/yr', notes: 'Required annually to maintain CCC certification.' },
  ],
  ...
  postApprovalObligations: [
    { item: 'Annual Factory Inspection', frequency: 'Yearly', description: 'CNCA inspector verifies production consistency.' },
    { item: 'Product Change Notice', frequency: 'When applicable', description: 'Design/component changes require re-evaluation.' },
    { item: 'CCC Certificate Renewal', frequency: 'Every 5 years', description: 'Full re-evaluation. Begin 6 months before expiry.' },
    { item: 'Market Surveillance', frequency: 'Ongoing', description: 'SAMR random product testing. Respond within 30 days.' },
  ],
  horizonScan: [
