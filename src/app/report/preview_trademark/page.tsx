    ...
    <div className="min-h-screen bg-bg-ice py-8">
      <div className="max-w-4xl mx-auto px-4 mb-4">
        <div className="bg-amber-50 border border-amber-300 rounded-lg p-4 text-center mb-6">
          <p className="text-sm font-bold text-amber-800">🔬 Preview Mode — Sample: NaturePure (USA)</p>
      ...
      <ReportTemplate
        ...
        locale="en"
        labels={labels}
        productInfo={{ name: "NaturePure", category: "Food Products (Class 29/30)", hsCode: "N/A", originCountry: "USA" }}
