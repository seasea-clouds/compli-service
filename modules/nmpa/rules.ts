...
export function checkCosmetics(input: any): any {
  ...
  return {
    ...
    regulations: [{"name": "Cosmetics Supervision & Administration Regulation", "number": "State Council Decree 727 (2021)", "authority": "NMPA", "relevance": "primary", "effectiveDate": "See document", "description": "Primary cosmetics regulation. Reformed the entire cosmetics regulatory system."}, {"name": "Cosmetics Registration & Filing Measures", "number": "NMPA 2021 No.1-3", "authority": "NMPA", "relevance": "primary", "effectiveDate": "See document", "description": "Detailed procedures for registration (special) vs filing (ordinary)."}, {"name": "Cosmetics Safety Assessment Guidelines", "number": "NMPA 2021 Tech Specs", "authority": "NMPA", "relevance": "primary", "effectiveDate": "See document", "description": "Required safety assessment report format and content."}, {"name": "Cosmetics Ingredients INCI Name Translation", "number": "NMPA ICSC Database", "authority": "NMPA", "relevance": "primary", "effectiveDate": "See document", "description": "Official Chinese translation of INCI names. Must be used in filing."}, {"name": "GB/T 35914-2018", "number": "GB/T 35914-2018", "authority": "NHC", "relevance": "secondary", "effectiveDate": "See document", "description": "Hygienic standard for cosmetics. Microbiological limits."}],
    ...
    timelinePhases: [{"phase": "Formula Review & Assessment", "duration": "1-3 weeks", "description": "Check ingredients against ICSC, determine special vs ordinary.", "responsible": "Both"}, {"phase": "Safety Assessment", "duration": "2-4 weeks", "description": "Engage NMPA-qualified safety assessor.", "responsible": "SinoTrade"}, {"phase": "Lab Testing", "duration": "3-8 weeks", "description": "Microbiological + heavy metals + efficacy if special.", "responsible": "SinoTrade"}, {"phase": "Dossier Compilation", "duration": "2-3 weeks", "description": "Compile all documents per NMPA format.", "responsible": "SinoTrade"}, {"phase": "NMPA Submission", "duration": "4-16 weeks", "description": "Filing (fast) or Registration (full review).", "responsible": "SinoTrade"}, {"phase": "Post-Approval Monitoring", "duration": "Ongoing", "description": "Annual reporting + change notifications.", "responsible": "Both"}],
    ...
    postApprovalObligations: [{"item": "Annual Production Report", "freq": "Yearly", "description": "Submit production data to NMPA."}, {"item": "Formula Change Notification", "freq": "When applicable", "description": "Any formula change requires re-filing or notification."}, {"item": "Label Update Compliance", "freq": "Per regulation change", "description": "Monitor NMPA labeling guideline updates."}, {"item": "Registration Renewal", "freq": "Every 5 years", "description": "Re-submit safety assessment for renewal."}],
