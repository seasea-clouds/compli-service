...
export function checkCcc(input: any): any {
  ...
  return {
    ...
    regulations: [{"name": "CNCA-CCC Implementation Rules", "number": "CNCA 00C-001:2023", "authority": "CNCA/SAMR", "relevance": "primary", "effectiveDate": "See document", "description": "CCC certification procedures: application, testing, factory inspection, certification maintenance."}, {"name": "CCC Product Catalogue", "number": "CNCA 2023 Announcement", "authority": "CNCA", "relevance": "primary", "effectiveDate": "See document", "description": "Products subject to mandatory CCC certification. 17 categories currently."}, {"name": "GB 4943.1-2022", "number": "GB 4943.1-2022", "authority": "NHC/CNCA", "relevance": "secondary", "effectiveDate": "See document", "description": "Safety of IT equipment. Mandatory for electronics CCC testing."}, {"name": "GB 4706.1-2005", "number": "GB 4706.1-2005 + 30 sub-standards", "authority": "CNCA", "relevance": "secondary", "effectiveDate": "See document", "description": "Safety of household appliances. Each product type has a specific sub-standard."}, {"name": "GB 6675 Series", "number": "GB 6675.1-.4:2014", "authority": "CNCA/SAMR", "relevance": "secondary", "effectiveDate": "See document", "description": "Toy safety: mechanical, flammability, chemical migration standards."}, {"name": "GB 17625.1-2022", "number": "GB 17625.1-2022", "authority": "CNCA", "relevance": "secondary", "effectiveDate": "See document", "description": "EMC harmonic current emissions."}, {"name": "China Energy Label", "number": "NDRC/MOFCOM 2020", "authority": "NDRC", "relevance": "secondary", "effectiveDate": "See document", "description": "Mandatory energy efficiency labeling for specified products."}, {"name": "China RoHS 2", "number": "MIIT Order 32:2016", "authority": "MIIT", "relevance": "secondary", "effectiveDate": "See document", "description": "Hazardous substances in electronic products."}],
    ...
    timelinePhases: [{"phase": "Pre-assessment & Application", "duration": "2-4 weeks", "description": "Determine GB standards, select lab, prepare application.", "responsible": "Both"}, {"phase": "Type Testing", "duration": "6-12 weeks", "description": "Safety + EMC testing at CNCA-accredited lab.", "responsible": "SinoTrade"}, {"phase": "Factory Inspection", "duration": "2-4 weeks", "description": "QMS audit per CCC requirements.", "responsible": "SinoTrade"}, {"phase": "Certification Review", "duration": "4-6 weeks", "description": "CNCA reviews test reports + inspection results.", "responsible": "CNCA"}, {"phase": "Certificate & Mark", "duration": "1-2 weeks", "description": "Certificate issued. CCC mark printing approval.", "responsible": "Both"}, {"phase": "Annual Maintenance", "duration": "Ongoing", "description": "Factory re-inspection + market surveillance.", "responsible": "Both"}],
    ...
    postApprovalObligations: [{"item": "Annual Factory Inspection", "freq": "Yearly", "description": "CNCA inspector verifies production consistency."}, {"item": "Product Change Notice", "freq": "When applicable", "description": "Design/component changes require re-evaluation."}, {"item": "CCC Certificate Renewal", "freq": "Every 5 years", "description": "Full re-evaluation. Begin 6 months before expiry."}, {"item": "Market Surveillance", "freq": "Ongoing", "description": "SAMR random product testing. Respond within 30 days."}],
